...
//   return (
//     <div className="m-2 p-2 ml-28 font-primary text-center">
...
//       <h1 className="text-2xl mt-3 p-1">New Product</h1>
...
//           onClick={onSaveBtn}
//           className="bg-primary text-white rounded px-4 py-1.5"
//         >
//           Save
//         </button>
//       </div>
...
function NewProduct() {
  ...
  return (
    <div className="flex justify-center items-center mt-8">
      <div className="m-2 p-2 font-primary text-center w-full max-w-md">
        <ShouldRender when={success}>
          <div className="py-2 my-4 bg-green-500 text-white rounded text-center font-semibold">
            Successfully saved data
          </div>
        </ShouldRender>
        ...
        <h1 className="flex text-2xl p-1 justify-center">New Product</h1>
        <div className="mt-4 mb-4">
          <label className="block py-1">Category</label>
          <select
            name="category"
